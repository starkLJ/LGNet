...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=os.path.join(data_root , 'annotations/UAVDT_train_coco.json'),
            img_prefix=os.path.join(data_root, 'images','train'),
            pipeline=train_pipeline)),
    val=dict(
        type=dataset_type,
        ann_file=os.path.join(data_root, 'annotations/UAVDT_test_coco.json'),
        img_prefix=os.path.join(data_root,'images','test'),
